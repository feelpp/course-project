...
:description: Build interactive web applications for scientific computing using Dash, Plotly, NumPy, and SciPy for dynamic data visualization.
...
NOTE: For the course weather-analysis project (`weather_hourly.csv`), use xref:dash-weather.adoc[Dash Weather Project Tutorial].
