...
**Friday: GitHub Review Lab (Issues, PRs, Projects)** _(90 minutes)_

Structured Review Lab (90 min)::
+
- Run xref:git-github:github-review-projects-lab.adoc[GitHub Review Lab: Issues, PRs, and Projects (90 minutes)]
- Create and triage issues with labels, assignees, and milestone
- Open, review, and merge one PR that closes an issue
