...
====
*🟡 LEVEL 2* | *Time:* 15-30 minutes | *Prerequisites:* None
====
...
1. xref:docker/hands-on/01-getting-started.adoc[Run your first containers]
2. Learn xref:docker/docker-commands.adoc[essential Docker commands]
3. Create your first xref:docker/dockerfile-basics.adoc[Dockerfile]
