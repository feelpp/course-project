= Historical Apptainer source-install recipe

WARNING: Historical administrator recipe for Apptainer 1.3.4. Versions and security configuration are dated; use the current official administrator guide. This is not the student installation procedure.
