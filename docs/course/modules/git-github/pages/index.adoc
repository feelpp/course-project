...
== Recommended Intro Session (M1)

If your class completed GitHub basics and is ready for first structured team workflow practice, run:

- xref:github-review-projects-lab.adoc[GitHub Intro Lab: Issues, PRs, and Projects (90 minutes)]
