...
NOTE: This is the retained legacy three-level schedule. Use xref:teaching-guide.adoc[the current M1/M2 teaching guide] for the course progression and first M2 session.
...
**Friday: GitHub Intro Lab (Issues, PRs, Projects)** _(90 minutes)_

Guided Intro Lab (90 min)::
+
- Run xref:git-github:github-review-projects-lab.adoc[GitHub Intro Lab: Issues, PRs, and Projects (90 minutes)]
- Create and triage issues with labels, assignees, and milestone
- Open and merge one PR that closes an issue
- Organize work in GitHub Project views (table + board)

Expected Outputs::
+
- Link to one project board configured with Status/Priority/Effort fields
- Link to one issue with labels, assignee, and milestone
- Link to one merged PR that closes its linked issue
- Short team retrospective (3-5 lines): what worked, what blocked progress

Quick Rubric for the Lab::
+
- **Project organization (30%)**: fields, views, and issue hygiene are correctly configured
- **Workflow correctness (30%)**: issue -> branch -> PR -> merge -> closed issue
- **Collaboration quality (20%)**: clear ownership, comments, and mentions
- **Reflection quality (20%)**: concise, actionable retrospective

**Week 2 Assessment:**
- Git workflow demonstration
- Collaborative exercise evaluation
- Repository/project organization quality
